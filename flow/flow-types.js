var types = [{
        ...
        init: function(i, o, that) {
            ...
            // but there's 3sue with webkit where user can't make it smaller.
		...
		*/
        ...
        init: function(i, o, that) {
            ...
            //alert("cust init id:" + that.id);
            lipDiv.id = that.id;
            //lipDiv.innerHTML = that.content;
            box.appendChild(lipDiv);

            //box.appendChild(that.content);            
